...
class Player {
    constructor(id, name, teamid, color, race) {
        ...
        this.actions = {
            timed: [],
            pause: { summary: 0, id: [], order: []},
            unpause: { summary: 0, id: [], order: []},
            assigngroup: 0,
            rightclick: 0,
            basic: 0,
            buildtrain: 0,
...
// ADDED 6/22/2024 ==============================
    handlePauseUnpause(itemid) {

        if (itemid === "pause") {
            this.actions.pause.summary++;
            this.actions.pause.id.push(itemid);
            this.actions.pause.order.push(this.currentTimePlayed);
        }
        else {
            this.actions.unpause.summary++;
            this.actions.unpause.id.push(itemid.type);
            this.actions.unpause.order.push(this.currentTimePlayed);
        }
    }
// ================================================
